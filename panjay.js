...
// [ ===== Import File ===== ]
import "./pan.js";
import "./database/Menu/PanjayMenu.js";
...
// Export Handler
export default async (panjay, m, meta) => {
  ...
  // Send File
  const PanjayFile = (buffer, fileName, mime) =>
    panjay.sendMessage(
      replyJid,
